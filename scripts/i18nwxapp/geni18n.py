...
gtOptions = '-a -d {} -o {}.pot -p "{}" "{}"'
tCmd = pyExe + ' ' + pyGettext + ' ' + (gtOptions.format(appC.langDomain,
                                                     appC.langDomain,
                                                     outFolder,
                                                     appFolder))
